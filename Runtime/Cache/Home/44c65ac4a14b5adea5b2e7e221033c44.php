        ...
        <div class="col-md-9">
            ...
            <div class="dogo-box">
                <div class="dogo-box-header">
                    <h3 class="dogo-flt">夏季美食</h3>
                    <p class="dogo-flt"><a href="">123</a>|<a href="">123</a>|<a href="">123</a></p>
                    <span class="dogo-header-more dogo-frt">124</span>
                </div><!--dogo-box-header-->
                <div class="dogo-box-content">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="thumbnail dogo-thumbnail">
                                <div class="dogo-thumbnail-pic">
                                    <a href="<?php echo U('Content/index',array('id'=>$vo['id']));?>">
                                        <img src="http://images.meishij.net/p/20150416/2accbb7b446dca6f27eb75e073148abe.jpg"/>
                                    </a>
                                </div>
                                <div class="dogo-thumbnail-footer">
                                    <h3><a href="<?php echo U('Content/index',array('id'=>$vo['id']));?>">糖醋里脊-丁氏做法糖醋里脊-丁氏做法</a></h3>
                                    <p>糖醋里脊-红烧肉</p>
                                </div>
                            </div><!--dogo-thumbnail-->
                        </div><!--col-md-->
                        <div class="col-md-3">
                            <div class="thumbnail dogo-thumbnail">
                                ...
                                <div class="dogo-thumbnail-footer">
                                    <h3><a href="<?php echo U('Content/index',array('id'=>$vo['id']));?>">糖醋里脊-丁氏做法</a></h3>
                                    <p>糖醋里脊-红烧肉</p>
                                </div>
                            </div><!--dogo-thumbnail-->
                        </div><!--col-md-->
                        ...
                        <div class="col-md-3">
                            <div class="thumbnail dogo-thumbnail">
                                ...
                                <div class="dogo-thumbnail-footer">
                                    <h3><a href="<?php echo U('Content/index',array('id'=>$vo['id']));?>">糖醋里脊-丁氏做法</a></h3>
                                    <p>糖醋里脊-红烧肉糖醋里脊-红烧肉糖醋里脊-红烧肉糖醋里脊-红烧肉</p>
                                </div>
                            </div><!--dogo-thumbnail-->
                        </div><!--col-md-->
                        <div class="col-md-3">
