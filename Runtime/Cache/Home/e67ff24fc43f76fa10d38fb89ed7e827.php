        ...
        <div class="col-md-9">
            <div class="dogo-box">
                ...
                <div class="dogo-box-content">
                    <div class="row">
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-3">
                                <div class="thumbnail dogo-thumbnail">
                                    <div class="dogo-thumbnail-pic">
                                        <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>">
                                            <img src="<?php echo ($vo["titlepic"]); ?>" alt="<?php echo ($vo["title"]); ?>" title="<?php echo ($vo["title"]); ?>"/>
                                        </a>
                                    </div>
                                    <div class="dogo-thumbnail-footer">
                                        <h3><a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></h3>
