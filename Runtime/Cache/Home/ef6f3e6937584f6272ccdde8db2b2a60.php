                                ...
                                <div class="panel-body dogo-list-text">
                                    <ul>
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>"><img src="<?php echo ($vo["titlepic"]); ?>" class="img-responsive" alt="<?php echo ($vo["title"]); ?>" title="<?php echo ($vo["title"]); ?>"/></a>
                                                    </div><!--col-md-->
                                                    <div class="col-md-8">
                                                        <h3><a href="<?php echo U('Home/Content/index',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></h3>
                                                        <h6>
                                                            <span class="glyphicon glyphicon-refresh"></span> <?php echo (date("m/d H:i",$vo["addtime"])); ?>
                                                            <span class="glyphicon glyphicon-list"></span> <a href="<?php echo U('Home/List/index',array('id'=>$vo['sort_id']));?>"><?php echo ($vo["text"]); ?></a>
