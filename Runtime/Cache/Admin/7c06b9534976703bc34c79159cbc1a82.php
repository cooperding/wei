...
<script>
    $(function() {
        ...
        var hrefadd = '<?php echo U("Admin/Setting/add",array("id"=>$id));?>';
        var hrefedit = '<?php echo U("Admin/Setting/edit");?>';
        var hrefcancel = '<?php echo U("Admin/Setting/delete");?>';
        var urljson = '<?php echo U("Admin/Setting/listJsonId",array("id"=>$id));?>';
        ...
        $('#datagrid_' + classId).datagrid({
            ...
            columns: [[
                    ...
                    {field: 'sys_name', title: '参数变量', width: 180},
                    {
                        field: 'action',
                        title: '操作',
                        width: 50,
