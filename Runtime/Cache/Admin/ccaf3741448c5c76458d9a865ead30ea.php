<?php if (!defined('THINK_PATH')) exit();?><table id="datagrid_members" class="datagrid">
</table>
...
<script>
    $(function() {
        ...
        var classId = 'members';
        var hrefadd = '<?php echo U("Admin/Members/add",array("id"=>$id));?>';
        var hrefedit = '<?php echo U("Admin/Members/edit");?>';
        var hrefcancel = '<?php echo U("Admin/Members/delete");?>';
        var urljson = '<?php echo U("Admin/Members/listJsonId",array("id"=>$id));?>';
